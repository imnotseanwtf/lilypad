...
class UpdateCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'addressType' => ['required', 'numeric',  'exists:addresstype:name'], // typeId
            ...
            'paymentTerms' => ['nullable', 'integer'], // defaultPaymentTermsId
            ...
            'carrierName' => ['nullable', 'string'], // defaultCarrierId
            'carrierService' => ['nullable', 'string'], // carrierServiceId
